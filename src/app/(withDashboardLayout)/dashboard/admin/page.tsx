                                ...
                                <div className="px-6 py-8">
                                    <div className="max-w-4xl mx-auto">
                                        <div className="bg-white rounded-3xl p-8 mb-5">
                                         ...
                                         <div className="flex items-center justify-between">
                                            ...
                                            <div className="grid grid-cols-2 gap-x-20">
                                                    ...
                                                    <div className="grid grid-cols-2 gap-4">
                                                        <div className="col-span-2">
                                                            <div className="p-4 bg-green-100 rounded-xl">
                                                                <div className="font-bold text-xl text-gray-800 leading-none"><span>Good day,</span> <span>{userData?.name}</span></div>
                                                                <div className="mt-5">
                                                        ...
                                                        <div className="p-4 bg-yellow-100 rounded-xl text-gray-800">
                                                            <div className="font-bold text-2xl leading-none">{projects?.length}</div>
                                                            <div className="mt-2">Total Projects</div>
                                                        </div>
                                                        <div className="p-4 bg-yellow-100 rounded-xl text-gray-800">
                                                            <div className="font-bold text-2xl leading-none">{blogs?.length}</div>
                                                            <div className="mt-2">Total Blogs</div>
                                                        </div>
                                                        <div className="col-span-2">
                                                ...
                                                <div>
                                                  ...
                                                  {/* projects */}
                                                  {
                                                    projects?.slice(0,1)?.map((project:TProject)=>   <div 
                                                    key={project._id}
                                         ...
                                         <p className=" text-gray-400 hover:text-yellow-800 hover:underline">
